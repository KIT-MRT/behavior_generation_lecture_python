...
class Vizard(object):
    ...
    def __init__(self, figure, update_func, time_vec):
        """
        Constructor
        :param interval: Update interval of animation's event source (timer).
        """
        self.plots = []
    ...
    def step(self, stepsize):
        ...
        :param stepsize: The stepsize to jump.
        """
        self.stop_measurement()
        self.pause()
    ...
    def setup(self, figure):
        ...
        :param figure: Handle to figure to add controls to.
        :return: Control class holding all controls.
        """
    ...
    def key_press_event(self, event):
        ...
        :param event: Information about the key event.
            currently only space and the four arrow keys are handled
        """
        if event.key == " ":
            self.playpause()
    ...
    def set_play_pause_label(self, label, controls=None):
        ...
        :param controls: (Optional) Handle to single controls class.
        """
        label_text = label
        if label == "run":
    ...
    def update_plot(self, controls, update_func, *args):
        ...
        :param controls: Handle to control class of figure.
        :param update_func: Handle to update function of plot class.
        :param args: Arguments to update_func.
